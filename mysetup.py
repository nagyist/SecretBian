#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe Sbian.py -W mysetup.py
...
Sbian = Target(
    ...
    script="Sbian.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'Sbian'
    # dest_base = "Sbian",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"Sbian.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="Sbian", level="asInvoker")).encode("utf-8")),
